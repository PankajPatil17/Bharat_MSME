...
class _BloodBankPageState extends State<BloodBankPage> {
  ...
  @override
  void initState() {
    ourservicescontroller.BloodBookingApi();
    super.initState();
  }
                  ...
                  children: [
                    ...
                    Center(
                      child: GestureDetector(
                        onTap: () {
                          ourservicescontroller.BloodBookingRequest();
                        },
                        child: Container(
  ...
  BannerImages() {
    return FutureBuilder(
      future: ourservicescontroller.BloodBookingApi(),
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return Container(
          ...
          child: CarouselSlider.builder(
            itemCount: ourservicescontroller.bloodbookingimages.length,
            itemBuilder: (BuildContext context, int index, int realIndex) {
              return Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(6),
                  child: Image.network(
                    ourservicescontroller.bloodbookingimages[index]['image'],
                    fit: BoxFit.fill,
                  ),
                ),
              );
  ...
  htmlData() {
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        return HtmlWidget(
          '''
                             ${ourservicescontroller.bloodBookinghtml}
                            ''',
